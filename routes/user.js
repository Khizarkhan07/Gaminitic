...
const {getuser, userById, updateuser, isOwner ,searchUsers, blockuser, unblockuser, getblockeduser, userProfile} = require("../controllers/user");
const {requireSignin} = require("../controllers/auth");

router.get("/get_user/:userId", requireSignin ,getuser);
router.get("/user", requireSignin ,userProfile);
